...
<div class="min-h-screen bg-white flex">
    ...
    <div class="hidden lg:block relative w-0 flex-1">
        <img class="absolute inset-0 h-full w-full object-cover"
            src="https://images.unsplash.com/photo-1505904267569-f02eaeb45a4c?ixlib=rb-1.2.1&ixqx=BweQ1V4IZi&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1908&q=80"
            alt="">
    </div>
</div>
...
{{-- <div class="flex">
    <form wire:submit.prevent="register">
        ...
        {!! Form::text('name', null, ["id" => "name", "wire:model.lazy" => "name"]) !!} 
        ...
        {!! Form::password('password',  ["id" => "password", "wire:model.lazy" => "password"]) !!} 
        @error('password') <span>{{$message}} </span> @enderror <br>
        
        {!! Form::label('passwordConfirmation', 'passwordConfirmation', []) !!}
        {!! Form::password('passwordConfirmation',  ["id" => "passwordConfirmation", "wire:model.lazy" => "passwordConfirmation"]) !!} 
