         <!-- Profile Image -->
          ...
          <a href="{{ route('team.edit',$admin->id) }}" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-blue-600 text-white hover:bg-blue-600 block w-full"><i class="fa fa-pencil" aria-hidden="true"></i> Modifier</a>
          @endif
